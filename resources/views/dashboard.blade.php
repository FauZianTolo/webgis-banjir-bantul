<x-app-layout>
    ...
    <style>
        ...
        .stats-card.blue::before { background: linear-gradient(90deg, #3b82f6, #2563eb); }
        .stats-card.green::before { background: linear-gradient(90deg, #10b981, #059669); }
        .stats-card.yellow::before { background: linear-gradient(90deg, #f59e0b, #d97706); }
        .stats-card.red::before { background: linear-gradient(90deg, #ef4444, #dc2626); }
        ...
        .stats-card.blue:hover { border-color: #3b82f6; }
        .stats-card.green:hover { border-color: #10b981; }
        .stats-card.yellow:hover { border-color: #f59e0b; }
        .stats-card.red:hover { border-color: #ef4444; }
        ...
        .stats-card.yellow .stats-icon { background: linear-gradient(135deg, #f59e0b, #d97706); }
        .stats-card.red .stats-icon { background: linear-gradient(135deg, #ef4444, #dc2626); }
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->foto)
                                <img src="{{ asset('uploads/laporan/' . $item->foto) }}"
                                     alt="Foto"
                                     class="rounded"
