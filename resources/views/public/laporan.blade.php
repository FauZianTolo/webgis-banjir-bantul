...
@section('styles')
    ...
    <style>
        ...
        .coord-display-box .coord-val span {
            display: block;
            margin-bottom: 3px;
        }

        .coord-display-box .coord-val span:last-child {
            margin-bottom: 0;
        }
        ...
        .coord-status-pill.ok {
            background: rgba(16, 185, 129, 0.35);
            border-color: #10b981;
        }

        .coord-status-pill.out {
        ...
        .auto-detect-badge.show {
            display: flex;
        }

        /* Outside-boundary warning badge */
        .outside-boundary-badge {
            display: none;
            align-items: center;
            gap: 6px;
            font-size: 12px;
        ...
        .map-status-badge.detected {
            background: rgba(16, 185, 129, 0.3);
            border-color: #10b981;
        }

        .map-status-badge.out-of-bounds {
            background: rgba(239, 68, 68, 0.4);
            border-color: #ef4444;
        }
        ...
        .coord-input-wrap input:focus {
            border-color: #0891b2;
            box-shadow: 0 0 0 3px rgba(8, 145, 178, 0.12);
            outline: none;
        }

        .coord-input-wrap input.has-value {
            border-color: #10b981;
            background: #f0fdf4;
        }
        ...
        .leaflet-tooltip::before {
            border-top-color: rgba(12, 74, 110, 0.92);
        }
...
@section('content')
    <div class="laporan-hero">
        <div class="container">
            ...
            <p class="text-center lead">Bantu kami memantau kejadian banjir di sekitar Anda dengan melaporkan secara
                real-time</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="info-top-inner">
                <div class="petunjuk-box">
                    <div class="petunjuk-title"><i class="fas fa-info-circle" style="color:#0891b2;"></i> Petunjuk Pelaporan
                    </div>
                    <ul>
                        ...
                        <li>Jika titik <strong>di luar wilayah Bantul</strong>, form kecamatan &amp; desa akan dikosongkan
                        </li>
    ...
    <div class="container my-5">
        ...
        <div class="form-container">
            <div
                style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:2rem;">
                <h4 style="margin:0;"><i class="fas fa-edit"></i> Formulir Pelaporan</h4>
                <a href="{{ route('laporan.status') }}"
                  ...
                  align-items:center;gap:7px;box-shadow:0 4px 15px rgba(8,145,178,0.3);
                  transition:all 0.2s;white-space:nowrap;"
                    onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 8px 20px rgba(8,145,178,0.4)'"
            ...
            <form action="{{ route('laporan.submit') }}" method="POST" enctype="multipart/form-data" id="formLaporan">
                ...
                <div class="map-section">
                    <div class="map-section-header">
                        <h6><i class="fas fa-map-pin"></i> Klik peta atau geser marker — kecamatan &amp; desa otomatis
                            terdeteksi</h6>
                    ...
                    <div class="coord-row">
                        <div class="coord-input-wrap">
                            <label><i class="fas fa-arrows-alt-v" style="color:#0891b2;"></i> Latitude (Y) <span
                                    style="color:#ef4444;">*</span></label>
                            <input type="number" id="inputLat" step="any" placeholder="-7.870000"
                                oninput="onCoordInput()" onchange="onCoordChange()">
                            <div class="coord-hint">Contoh: -7.870000 (negatif = Selatan)</div>
                        </div>
                        <div class="coord-input-wrap">
                            <label><i class="fas fa-arrows-alt-h" style="color:#0891b2;"></i> Longitude (X) <span
                                    style="color:#ef4444;">*</span></label>
                            <input type="number" id="inputLon" step="any" placeholder="110.330000"
                                oninput="onCoordInput()" onchange="onCoordChange()">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama_pelapor" class="form-control"
                            placeholder="Masukkan nama lengkap Anda" value="{{ old('nama_pelapor') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="outside-boundary-badge" id="kecOobBadge">
                            <i class="fas fa-exclamation-triangle"></i> <span>Titik di luar wilayah Bantul — pilih
                                manual</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="outside-boundary-badge" id="desaOobBadge">
                            <i class="fas fa-exclamation-triangle"></i> <span>Tidak terdeteksi — pilih manual setelah
                                memilih kecamatan</span>
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="4"
                        placeholder="Jelaskan detail kejadian banjir (penyebab, dampak, kondisi terkini, dll)" required>{{ old('deskripsi') }}</textarea>
                    <small class="text-muted"><i class="fas fa-lightbulb"></i> Berikan deskripsi sejelas mungkin untuk
                        membantu tim BPBD</small>
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label">
                        ...
                        <span class="badge"
                            style="background:#fef3c7;color:#92400e;font-size:0.75rem;margin-left:6px;">Opsional</span>
                    </label>
                    ...
                    <small class="text-muted"><i class="fas fa-info-circle" style="color:#f59e0b;"></i> Tuliskan barang
                        atau alat yang dibutuhkan agar BPBD dapat menyiapkan bantuan yang tepat</small>
                </div>

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Perkiraan Kedalaman Air (cm)</label>
                        <input type="number" name="kedalaman_cm" class="form-control" placeholder="Contoh: 50"
                            min="1" value="{{ old('kedalaman_cm') }}">
                        <small class="text-muted"><i class="fas fa-ruler-vertical"></i> Perkiraan kedalaman genangan dalam
                            cm</small>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label">
                            ...
                            <span class="badge"
                                style="background:#e0f2fe;color:#0369a1;font-size:0.75rem;margin-left:6px;">Maks. 3
                                Foto</span>
                        </label>
                        <input type="file" name="fotos[]" id="fotoInput" class="form-control" required
                            accept="image/jpeg,image/png,image/jpg" multiple>
                        <small class="text-muted"><i class="fas fa-info-circle"></i> Wajib upload min. 1 foto sebagai
                            bukti kejadian. Format: JPG/PNG. Maks. 2MB/foto.</small>
                        <div id="fotoPreviewGrid" style="display:none;margin-top:12px;">
                            <div style="font-size:0.85rem;font-weight:700;color:#0c4a6e;margin-bottom:8px;"><i
                                    class="fas fa-images"></i> Preview Foto:</div>
                ...
                <div class="alert alert-warning mb-4">
                    <i class="fas fa-exclamation-triangle"></i>
                    <strong>Penting!</strong> Pastikan lokasi sudah ditentukan di peta dan foto kejadian sudah diupload
...
@section('script')
    ...
    <script>
        ...
        // ══════════════════════════════════════════════════════════════════════
        const kelurahanData = {
            'Banguntapan': ['Banguntapan', 'Baturetno', 'Jagalan', 'Jambidan', 'Potorono', 'Singosaren', 'Tamanan',
                'Wirokerten'
            ],
            ...
            'Imogiri': ['Girirejo', 'Imogiri', 'Karangtalun', 'Karangtengah', 'Kebonagung', 'Selopamioro', 'Sriharjo',
                'Wukirsari'
            ],
        ...
        function zoomToKecamatan(kecNama, geojsonData) {
            ...
            map.flyToBounds(tmpLayer.getBounds(), {
                padding: [30, 30],
                duration: 0.8
            });
        }
        ...
        function setLocation(lat, lng, source) {
            ...
            iLat.value = lat;
            iLon.value = lng;
            iLat.classList.add('has-value');
            iLon.classList.add('has-value');
            ...
            if (source !== 'drag') {
                map.flyTo([lat, lng], source === 'gps' ? 16 : 14, {
                    duration: 1.2
                });
            }
        ...
        document.getElementById('formLaporan').addEventListener('submit', function(e) {
            ...
            if (!fotoSelected) {
                ...
                document.getElementById('fotoInput').scrollIntoView({
                    behavior: 'smooth',
                    block: 'center'
                });
                return false;
            ...
            if (!kecVal) {
                ...
                document.getElementById('selectKecamatan').scrollIntoView({
                    behavior: 'smooth',
                    block: 'center'
                });
                return false;
