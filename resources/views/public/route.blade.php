...
<link href='https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800;900&display=swap' rel='stylesheet'>
    ...
    <style>
        ...
        .route-hero h1 { position:relative; z-index:2; font-weight:900; font-size:2.8rem; text-shadow:2px 2px 4px rgba(0,0,0,0.3); }
        .route-hero p  { position:relative; z-index:2; font-size:1.2rem; opacity:0.95; }
