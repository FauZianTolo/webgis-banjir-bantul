                            ...
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    <button onclick="showDetail({{ $item->id }})"
                                        class="btn btn-sm btn-detail mb-1">
                                        <i class="fas fa-info-circle"></i> Detail
                                    </button>

                                    <a href="{{ route('admin.points.edit', $item->id) }}"
                                        class="btn btn-sm btn-edit mb-1">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>

                                    <form action="{{ route('admin.points.destroy', $item->id) }}" method="POST"
                                        class="d-inline" onsubmit="return confirm('Hapus data ini secara permanen?');">
                                        @csrf
                                        @method('DELETE')
