    ...
    <style>
        ...
        .stats-mini.pending::before { background: linear-gradient(90deg, #f59e0b, #d97706); }
        .stats-mini.verified::before { background: linear-gradient(90deg, #10b981, #059669); }
        .stats-mini.rejected::before { background: linear-gradient(90deg, #ef4444, #dc2626); }
        ...
        .stats-mini.pending:hover { border-color: #f59e0b; }
        .stats-mini.verified:hover { border-color: #10b981; }
        .stats-mini.rejected:hover { border-color: #ef4444; }
        ...
        .stats-mini.pending .stats-mini-icon { background: linear-gradient(135deg, #f59e0b, #d97706); }
        .stats-mini.verified .stats-mini-icon { background: linear-gradient(135deg, #10b981, #059669); }
        .stats-mini.rejected .stats-mini-icon { background: linear-gradient(135deg, #ef4444, #dc2626); }
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                ...
                                <button onclick="showDetail({{ $item->id }})" class="btn btn-sm btn-detail">
